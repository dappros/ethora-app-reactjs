...
export const aiWidget = {
  en: {
    ...
    'agentPanels.flowsIntro': 'Flows are scripted conversations: an opening menu, an intake questionnaire, an appointment request. Write them in YAML below (pick a template to start). The reserved flow "start" is shown when a conversation opens; other flows start from a menu button, a trigger phrase, or when the agent recognises the intent.',
    'agentPanels.flowsPlaceholder': 'version: 1\nflows:\n  start:\n    steps:\n      - say: "Hi! How can I help?"\n        buttons:\n          - { label: "Ask a question", end: true }',
    'agentPanels.validateFlows': 'Validate',
    'agentPanels.saveFlows': 'Save flows',
    'agentPanels.flowsValid': 'Flows script is valid',
    'agentPanels.flowsInvalid': 'Flows script has errors - see below',
    'agentPanels.flowsSaved': 'Flows saved',
    'agentPanels.flowsFound': 'Flows found:',
    'agentPanels.flowsNone': 'No flows defined (the agent will chat freely).',
    'agentPanels.flowsHint': 'Step kinds: say (message, optional buttons with goto / end), ask (one answer: text, number, date, phone, email, or options for buttons), goto, end. Use {slot} in text to repeat an answer and "when: slot == value" to skip a step. Answers stay in the chat transcript.',
  ...
  fr: {
    ...
    'agentPanels.flowsIntro': 'Les parcours sont des conversations scriptées : menu d\'accueil, questionnaire d\'admission, demande de rendez-vous. Écrivez-les en YAML ci-dessous (choisissez un modèle pour commencer). Le parcours réservé « start » s\'affiche à l\'ouverture d\'une conversation ; les autres démarrent depuis un bouton du menu, une phrase déclencheuse ou lorsque l\'agent reconnaît l\'intention.',
    'agentPanels.flowsPlaceholder': 'version: 1\nflows:\n  start:\n    steps:\n      - say: "Bonjour ! Comment puis-je vous aider ?"\n        buttons:\n          - { label: "Poser une question", end: true }',
    'agentPanels.validateFlows': 'Valider',
    'agentPanels.saveFlows': 'Enregistrer les parcours',
    'agentPanels.flowsValid': 'Le script des parcours est valide',
    'agentPanels.flowsInvalid': 'Le script des parcours contient des erreurs - voir ci-dessous',
    'agentPanels.flowsSaved': 'Parcours enregistrés',
    'agentPanels.flowsFound': 'Parcours trouvés :',
    'agentPanels.flowsNone': 'Aucun parcours défini (l\'agent discute librement).',
    'agentPanels.flowsHint': 'Types d\'étapes : say (message, boutons facultatifs avec goto / end), ask (une réponse : text, number, date, phone, email, ou options pour des boutons), goto, end. Utilisez {slot} dans un texte pour reprendre une réponse et « when: slot == value » pour sauter une étape. Les réponses restent dans la transcription du chat.',
  ...
  es: {
    ...
    'agentPanels.flowsIntro': 'Los flujos son conversaciones guionizadas: un menú inicial, un cuestionario de admisión, una solicitud de cita. Escríbelos en YAML abajo (elige una plantilla para empezar). El flujo reservado "start" se muestra al abrir una conversación; los demás empiezan desde un botón del menú, una frase de activación o cuando el agente reconoce la intención.',
    'agentPanels.flowsPlaceholder': 'version: 1\nflows:\n  start:\n    steps:\n      - say: "¡Hola! ¿En qué puedo ayudarte?"\n        buttons:\n          - { label: "Hacer una pregunta", end: true }',
    'agentPanels.validateFlows': 'Validar',
    'agentPanels.saveFlows': 'Guardar flujos',
    'agentPanels.flowsValid': 'El script de flujos es válido',
    'agentPanels.flowsInvalid': 'El script de flujos tiene errores - ver abajo',
    'agentPanels.flowsSaved': 'Flujos guardados',
    'agentPanels.flowsFound': 'Flujos encontrados:',
    'agentPanels.flowsNone': 'No hay flujos definidos (el agente conversa libremente).',
    'agentPanels.flowsHint': 'Tipos de paso: say (mensaje, botones opcionales con goto / end), ask (una respuesta: text, number, date, phone, email, u options para botones), goto, end. Usa {slot} en un texto para repetir una respuesta y "when: slot == value" para saltar un paso. Las respuestas quedan en la transcripción del chat.',
