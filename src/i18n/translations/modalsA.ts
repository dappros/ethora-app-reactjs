...
export const modalsA = {
  en: {
    ...
    'aclModal.preset_analyst_hint': 'Sees the app, its users and its statistics',
    ...
    'aclModal.cap_viewUsers': 'View users',
    'aclModal.cap_viewUsers_hint': 'See the users list, tags, CSV export and message search',
    'aclModal.cap_manageUsers': 'Manage users',
    'aclModal.cap_manageUsers_hint': 'Create and edit users, reset passwords and two-step verification',
  ...
  fr: {
    ...
    'aclModal.preset_analyst_hint': "Voit l'application, ses utilisateurs et ses statistiques",
    ...
    'aclModal.cap_viewUsers': 'Voir les utilisateurs',
    'aclModal.cap_viewUsers_hint': "Voir la liste des utilisateurs, les étiquettes, l'export CSV et la recherche de messages",
    'aclModal.cap_manageUsers': 'Gérer les utilisateurs',
    'aclModal.cap_manageUsers_hint': 'Créer et modifier des utilisateurs, réinitialiser mots de passe et vérification en deux étapes',
  ...
  es: {
    ...
    'aclModal.preset_analyst_hint': 'Ve la aplicación, sus usuarios y sus estadísticas',
    ...
    'aclModal.cap_viewUsers': 'Ver usuarios',
    'aclModal.cap_viewUsers_hint': 'Ver la lista de usuarios, etiquetas, exportación CSV y búsqueda de mensajes',
    'aclModal.cap_manageUsers': 'Gestionar usuarios',
    'aclModal.cap_manageUsers_hint': 'Crear y editar usuarios, restablecer contraseñas y verificación en dos pasos',
