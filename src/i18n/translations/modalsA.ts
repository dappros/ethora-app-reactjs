...
export const modalsA = {
  en: {
    ...
    'aclModal.serverLevelDescription':
      'Access to installation-wide information, above any single app.',
    'aclModal.rowNetworkStatistics': 'Network statistics (read)',
    'aclModal.cancel': 'Cancel',
    'aclModal.updateAcl': 'Update ACL',
    'aclModal.presetsTitle': 'Role',
    'aclModal.presetsDescription': 'Pick a role, or adjust the grid below for a custom set.',
    ...
    'aclModal.preset_userManager_hint': 'Manages users of this app',
    'aclModal.preset_admin': 'Admin',
    'aclModal.preset_admin_hint': 'Manages everything in this app',
    'aclModal.preset_custom': 'Custom',
    'aclModal.preset_custom_hint': 'Set from the grid below',
    'aclModal.settingsReadLocked': 'Settings > Read stays on while anything else is granted',
    'aclModal.settingsReadNote': 'Settings > Read is what makes the app appear in the user’s list; it is kept on whenever any other permission is granted.',
  ...
  fr: {
    ...
    'aclModal.serverLevelDescription':
      "Accès aux informations de toute l'installation, au-delà d'une seule application.",
    'aclModal.rowNetworkStatistics': 'Statistiques réseau (lecture)',
    'aclModal.cancel': 'Annuler',
    'aclModal.updateAcl': 'Mettre à jour les ACL',
    'aclModal.presetsTitle': 'Rôle',
    'aclModal.presetsDescription': 'Choisissez un rôle, ou ajustez la grille ci-dessous pour un ensemble personnalisé.',
    ...
    'aclModal.preset_userManager_hint': 'Gère les utilisateurs de cette application',
    'aclModal.preset_admin': 'Admin',
    'aclModal.preset_admin_hint': 'Gère tout dans cette application',
    'aclModal.preset_custom': 'Personnalisé',
    'aclModal.preset_custom_hint': 'Défini dans la grille ci-dessous',
    'aclModal.settingsReadLocked': "Réglages > Lire reste activé tant qu'une autre permission est accordée",
    'aclModal.settingsReadNote': "Réglages > Lire fait apparaître l'application dans la liste de l'utilisateur ; il reste activé dès qu'une autre permission est accordée.",
  ...
  es: {
    ...
    'aclModal.serverLevelDescription':
      'Acceso a información de toda la instalación, más allá de una sola aplicación.',
    'aclModal.rowNetworkStatistics': 'Estadísticas de red (lectura)',
    'aclModal.cancel': 'Cancelar',
    'aclModal.updateAcl': 'Actualizar ACL',
    'aclModal.presetsTitle': 'Rol',
    'aclModal.presetsDescription': 'Elige un rol, o ajusta la cuadrícula de abajo para un conjunto personalizado.',
    ...
    'aclModal.preset_userManager_hint': 'Gestiona los usuarios de esta aplicación',
    'aclModal.preset_admin': 'Admin',
    'aclModal.preset_admin_hint': 'Gestiona todo en esta aplicación',
    'aclModal.preset_custom': 'Personalizado',
    'aclModal.preset_custom_hint': 'Definido en la cuadrícula de abajo',
    'aclModal.settingsReadLocked': 'Ajustes > Leer se mantiene activo mientras haya otro permiso concedido',
    'aclModal.settingsReadNote': 'Ajustes > Leer es lo que hace que la aplicación aparezca en la lista del usuario; se mantiene activo siempre que se conceda otro permiso.',
