...
export const adminCore = {
  en: {
    ...
    'appUsers.platformAccessTitle': 'Platform access',
    'platformAccess.title': 'Platform access for {user}',
    'platformAccess.description': 'What this person may do across the whole installation, not just in one app.',
    'platformAccess.superadmin': 'Superadmin',
    'platformAccess.superadmin_hint': 'Sees and manages every app and setting, and can add or remove other superadmins. Only for people who run the platform.',
    'platformAccess.agents': 'Can create AI agents',
    'platformAccess.agents_hint': 'Create, clone and import agents. Agents belong to the person who made them, not to an app.',
    'platformAccess.netStats': 'Network statistics',
    'platformAccess.netStats_hint': 'Read installation-wide statistics, above any single app',
    'platformAccess.loading': 'Loading',
    'platformAccess.loadFailedPrefix': 'Could not load platform access:',
    'platformAccess.saveFailedPrefix': 'Could not save platform access:',
    'platformAccess.savedToast': 'Platform access updated.',
    'platformAccess.revokeSelf': 'You cannot remove your own superadmin access.',
    'platformAccess.cancel': 'Cancel',
    'platformAccess.save': 'Save',
  ...
  fr: {
    ...
    'appUsers.platformAccessTitle': 'Accès plateforme',
    'platformAccess.title': 'Accès plateforme de {user}',
    'platformAccess.description': "Ce que cette personne peut faire sur toute l'installation, pas seulement dans une application.",
    'platformAccess.superadmin': 'Superadmin',
    'platformAccess.superadmin_hint': "Voit et gère toutes les applications et tous les réglages, et peut ajouter ou retirer d'autres superadmins. Réservé aux personnes qui administrent la plateforme.",
    'platformAccess.agents': 'Peut créer des agents IA',
    'platformAccess.agents_hint': "Créer, cloner et importer des agents. Un agent appartient à la personne qui l'a créé, pas à une application.",
    'platformAccess.netStats': 'Statistiques réseau',
    'platformAccess.netStats_hint': "Lire les statistiques de toute l'installation, au-delà d'une seule application",
    'platformAccess.loading': 'Chargement',
    'platformAccess.loadFailedPrefix': "Impossible de charger l'accès plateforme :",
    'platformAccess.saveFailedPrefix': "Impossible d'enregistrer l'accès plateforme :",
    'platformAccess.savedToast': 'Accès plateforme mis à jour.',
    'platformAccess.revokeSelf': 'Vous ne pouvez pas retirer votre propre accès superadmin.',
    'platformAccess.cancel': 'Annuler',
    'platformAccess.save': 'Enregistrer',
  ...
  es: {
    ...
    'appUsers.platformAccessTitle': 'Acceso a la plataforma',
    'platformAccess.title': 'Acceso a la plataforma de {user}',
    'platformAccess.description': 'Lo que esta persona puede hacer en toda la instalación, no solo en una aplicación.',
    'platformAccess.superadmin': 'Superadmin',
    'platformAccess.superadmin_hint': 'Ve y gestiona todas las aplicaciones y ajustes, y puede añadir o quitar otros superadmins. Solo para quienes administran la plataforma.',
    'platformAccess.agents': 'Puede crear agentes de IA',
    'platformAccess.agents_hint': 'Crear, clonar e importar agentes. Un agente pertenece a quien lo creó, no a una aplicación.',
    'platformAccess.netStats': 'Estadísticas de red',
    'platformAccess.netStats_hint': 'Leer estadísticas de toda la instalación, más allá de una sola aplicación',
    'platformAccess.loading': 'Cargando',
    'platformAccess.loadFailedPrefix': 'No se pudo cargar el acceso a la plataforma:',
    'platformAccess.saveFailedPrefix': 'No se pudo guardar el acceso a la plataforma:',
    'platformAccess.savedToast': 'Acceso a la plataforma actualizado.',
    'platformAccess.revokeSelf': 'No puedes quitar tu propio acceso superadmin.',
    'platformAccess.cancel': 'Cancelar',
    'platformAccess.save': 'Guardar',
