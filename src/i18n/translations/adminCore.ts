...
export const adminCore = {
  en: {
    ...
    'appUsers.colName': 'Name',
    'appUsers.sortAuthMethod': 'Auth method',
    'appUsers.sortMfa': 'MFA status',
    'appUsers.sortTags': 'Tags (tagged first)',
    'appUsers.sortRole': 'Role (admins first)',
    'appUsers.sortHintTagsAsc': 'Show users without tags first',
    'appUsers.sortHintTagsDesc': 'Show tagged users first',
    'appUsers.sortHintRoleAsc': 'Show members first',
    'appUsers.sortHintRoleDesc': 'Show superadmins, owner and admins first',
    'appUsers.sortByTitle': 'Sort by {column}',
    'appUsers.authMethod_email': 'Signed in with email and password',
    'appUsers.authMethod_google': 'Signed in with Google',
    'appUsers.authMethod_gmail': 'Signed in with Google',
    'appUsers.authMethod_facebook': 'Signed in with Facebook',
    'appUsers.authMethod_apple': 'Signed in with Apple',
    'appUsers.authMethod_metamask': 'Signed in with a wallet (MetaMask)',
    'appUsers.authMethod_signature': 'Signed in with a wallet signature',
    'appUsers.authMethod_unknown': 'No sign-in method recorded yet',
    'appUsers.editTitle': 'Edit user',
    'appUsers.userUpdatedToast': 'User updated.',
    'appUsers.userUpdateFailedPrefix': 'Could not update the user:',
    'appUsers.tagFilterPrefix': 'Tag:',
    'appUsers.tagFilterClear': 'Clear tag filter',
    'appUsers.tagFilterTitle': 'Show only users tagged {tag}',
    'appUsers.tagsModalSubtext': 'Applies to {count} selected user(s). Other tags they already have are kept.',
    'appUsers.tagsAddLabel': 'Add tags',
    'appUsers.tagsAddPlaceholder': 'Type a tag and press Enter',
    'appUsers.tagsRemoveLabel': 'Remove tags',
    'appUsers.tagsRemovePlaceholder': 'Tags to take away from the selected users',
    'appUsers.tagsRemoveTitle': 'Click to remove this tag from the selected users',
    'appUsers.tagsFailedPrefix': 'Could not update tags:',
    'editUserModal.title': 'Edit user',
    'editUserModal.close': 'Close',
    'editUserModal.firstName': 'First name',
    'editUserModal.lastName': 'Last name',
    'editUserModal.nameRule': '3 to 30 characters',
    'editUserModal.description': 'Description (optional)',
    'editUserModal.descriptionPlaceholder': 'A short note shown on the profile',
    'editUserModal.tags': 'Tags',
    'editUserModal.tagsPlaceholder': 'Type a tag and press Enter',
    'editUserModal.cancel': 'Cancel',
    'editUserModal.save': 'Save',
    'appUsers.colRole': 'Role',
    'appUsers.colMfa': 'MFA',
    'appUsers.mfaOn': 'On',
    'appUsers.mfaOff': 'Off',
    'appUsers.role_superadmin': 'Superadmin',
    'appUsers.role_owner': 'Owner',
    'appUsers.role_admin': 'Admin',
    'appUsers.role_member': 'Member',
    'appUsers.tabAllUsers': 'All users',
    'appUsers.tabAdminAccess': 'Admin access',
    'appUsers.tabAdminAccessTitle': 'Only users who can manage this app in the admin panel: owner, admins, platform superadmins',
    'appUsers.revokeAccess': 'Remove admin access',
    'appUsers.revokeAccessTitle': 'Turn off every admin-panel permission for the selected users; their account and chat stay',
    'appUsers.revokeAccessConfirmTitlePrefix': 'Remove admin access for',
    'appUsers.revokeAccessConfirmMessage': 'They can still sign in and chat, but can no longer manage this app, its users or settings. To block the account entirely use Archive instead. The app owner and your own account are skipped.',
    'appUsers.accessRevokedToast': 'Admin access removed for {count} user(s).',
    'appUsers.accessRevokeSelf': 'Your own account was skipped.',
    'appUsers.accessRevokeOwner': 'The app owner was skipped.',
    'appUsers.accessRevokeSuperadmin': 'A platform superadmin can only be demoted by another superadmin; their app permissions were removed.',
    'appUsers.superAdminGrant': 'Make superadmin',
    'appUsers.superAdminGrantTitle': 'Platform-wide access to every app and setting, like your own account',
    'appUsers.superAdminGrantConfirmTitlePrefix': 'Make superadmin:',
    'appUsers.superAdminGrantConfirmMessage':
      'A superadmin sees and manages every app on this installation, can add or remove other superadmins, and is not limited by app permissions. Only give this to people who run the platform.',
    'appUsers.superAdminGrantedToast': 'Superadmin access given to {count} user(s).',
    'appUsers.superAdminRevoke': 'Remove superadmin',
    'appUsers.superAdminRevokeTitle': 'Take platform-wide access away; their permissions on this app are kept',
    'appUsers.superAdminRevokeConfirmTitlePrefix': 'Remove superadmin from',
    'appUsers.superAdminRevokeConfirmMessage':
      'They keep their account and whatever permissions they hold on this app, but no longer see other apps or manage the platform.',
    'appUsers.superAdminRevokedToast': 'Superadmin access removed from {count} user(s).',
    'appUsers.superAdminRevokeSelf': 'You cannot remove your own superadmin access.',
    'appUsers.superAdminNotBaseApp': 'Superadmins are managed from the base app’s Users page.',
    'appUsers.superAdminRequired': 'Only a superadmin can change superadmin access.',
  ...
  fr: {
    ...
    'appUsers.colAttribution': 'Attribution',
    'appUsers.colActions': 'Actions',
    'appUsers.colName': 'Nom',
    'appUsers.sortAuthMethod': 'Méthode d\'authentification',
    'appUsers.sortMfa': 'Statut MFA',
    'appUsers.sortTags': 'Étiquettes (étiquetés d\'abord)',
    'appUsers.sortRole': 'Rôle (admins d\'abord)',
    'appUsers.sortHintTagsAsc': 'Afficher d\'abord les utilisateurs sans étiquette',
    'appUsers.sortHintTagsDesc': 'Afficher d\'abord les utilisateurs étiquetés',
    'appUsers.sortHintRoleAsc': 'Afficher d\'abord les membres',
    'appUsers.sortHintRoleDesc': 'Afficher d\'abord les superadmins, le propriétaire et les admins',
    'appUsers.sortByTitle': 'Trier par {column}',
    'appUsers.authMethod_email': 'Connexion par e-mail et mot de passe',
    'appUsers.authMethod_google': 'Connexion avec Google',
    'appUsers.authMethod_gmail': 'Connexion avec Google',
    'appUsers.authMethod_facebook': 'Connexion avec Facebook',
    'appUsers.authMethod_apple': 'Connexion avec Apple',
    'appUsers.authMethod_metamask': 'Connexion avec un portefeuille (MetaMask)',
    'appUsers.authMethod_signature': 'Connexion par signature de portefeuille',
    'appUsers.authMethod_unknown': 'Aucune méthode de connexion enregistrée',
    'appUsers.editTitle': 'Modifier l\'utilisateur',
    'appUsers.userUpdatedToast': 'Utilisateur mis à jour.',
    'appUsers.userUpdateFailedPrefix': 'Impossible de mettre à jour l\'utilisateur :',
    'appUsers.tagFilterPrefix': 'Étiquette :',
    'appUsers.tagFilterClear': 'Effacer le filtre d\'étiquette',
    'appUsers.tagFilterTitle': 'Afficher uniquement les utilisateurs avec l\'étiquette {tag}',
    'appUsers.tagsModalSubtext': 'S\'applique à {count} utilisateur(s) sélectionné(s). Leurs autres étiquettes sont conservées.',
    'appUsers.tagsAddLabel': 'Ajouter des étiquettes',
    'appUsers.tagsAddPlaceholder': 'Saisissez une étiquette puis Entrée',
    'appUsers.tagsRemoveLabel': 'Retirer des étiquettes',
    'appUsers.tagsRemovePlaceholder': 'Étiquettes à retirer aux utilisateurs sélectionnés',
    'appUsers.tagsRemoveTitle': 'Cliquez pour retirer cette étiquette aux utilisateurs sélectionnés',
    'appUsers.tagsFailedPrefix': 'Impossible de mettre à jour les étiquettes :',
    'editUserModal.title': 'Modifier l\'utilisateur',
    'editUserModal.close': 'Fermer',
    'editUserModal.firstName': 'Prénom',
    'editUserModal.lastName': 'Nom',
    'editUserModal.nameRule': '3 à 30 caractères',
    'editUserModal.description': 'Description (facultatif)',
    'editUserModal.descriptionPlaceholder': 'Une courte note affichée sur le profil',
    'editUserModal.tags': 'Étiquettes',
    'editUserModal.tagsPlaceholder': 'Saisissez une étiquette puis Entrée',
    'editUserModal.cancel': 'Annuler',
    'editUserModal.save': 'Enregistrer',
    'appUsers.colRole': 'Rôle',
    'appUsers.colMfa': 'MFA',
    'appUsers.mfaOn': 'Activée',
    'appUsers.mfaOff': 'Désactivée',
    'appUsers.role_superadmin': 'Superadmin',
    'appUsers.role_owner': 'Propriétaire',
    'appUsers.role_admin': 'Admin',
    'appUsers.role_member': 'Membre',
    'appUsers.tabAllUsers': 'Tous les utilisateurs',
    'appUsers.tabAdminAccess': 'Accès admin',
    'appUsers.tabAdminAccessTitle': 'Uniquement les utilisateurs pouvant gérer cette application dans le panneau d\'administration : propriétaire, admins, superadmins de la plateforme',
    'appUsers.revokeAccess': 'Retirer l\'accès admin',
    'appUsers.revokeAccessTitle': 'Désactiver toutes les permissions du panneau d\'administration pour les utilisateurs sélectionnés ; leur compte et le chat sont conservés',
    'appUsers.revokeAccessConfirmTitlePrefix': 'Retirer l\'accès admin pour',
    'appUsers.revokeAccessConfirmMessage': 'Ils pourront toujours se connecter et discuter, mais ne pourront plus gérer cette application, ses utilisateurs ou ses paramètres. Pour bloquer entièrement le compte, utilisez Archiver. Le propriétaire de l\'application et votre propre compte sont ignorés.',
    'appUsers.accessRevokedToast': 'Accès admin retiré pour {count} utilisateur(s).',
    'appUsers.accessRevokeSelf': 'Votre propre compte a été ignoré.',
    'appUsers.accessRevokeOwner': 'Le propriétaire de l\'application a été ignoré.',
    'appUsers.accessRevokeSuperadmin': 'Un superadmin de la plateforme ne peut être rétrogradé que par un autre superadmin ; ses permissions sur l\'application ont été retirées.',
    'appUsers.superAdminGrant': 'Nommer superadmin',
    'appUsers.superAdminGrantTitle': 'Accès à toutes les applications et tous les réglages de la plateforme, comme votre propre compte',
    'appUsers.superAdminGrantConfirmTitlePrefix': 'Nommer superadmin :',
    'appUsers.superAdminGrantConfirmMessage':
      'Un superadmin voit et gère toutes les applications de cette installation, peut ajouter ou retirer d\'autres superadmins et n\'est pas limité par les permissions d\'application. Réservez-le aux personnes qui administrent la plateforme.',
    'appUsers.superAdminGrantedToast': 'Accès superadmin accordé à {count} utilisateur(s).',
    'appUsers.superAdminRevoke': 'Retirer superadmin',
    'appUsers.superAdminRevokeTitle': 'Retirer l\'accès à toute la plateforme ; les permissions sur cette application sont conservées',
    'appUsers.superAdminRevokeConfirmTitlePrefix': 'Retirer le statut superadmin à',
    'appUsers.superAdminRevokeConfirmMessage':
      'Le compte et les permissions sur cette application sont conservés, mais la personne ne voit plus les autres applications et n\'administre plus la plateforme.',
    'appUsers.superAdminRevokedToast': 'Accès superadmin retiré à {count} utilisateur(s).',
    'appUsers.superAdminRevokeSelf': 'Vous ne pouvez pas retirer votre propre accès superadmin.',
    'appUsers.superAdminNotBaseApp': 'Les superadmins se gèrent depuis la page Utilisateurs de l\'application de base.',
    'appUsers.superAdminRequired': 'Seul un superadmin peut modifier l\'accès superadmin.',
  ...
  es: {
    ...
    'appUsers.colName': 'Nombre',
    'appUsers.sortAuthMethod': 'Método de autenticación',
    'appUsers.sortMfa': 'Estado MFA',
    'appUsers.sortTags': 'Etiquetas (etiquetados primero)',
    'appUsers.sortRole': 'Rol (admins primero)',
    'appUsers.sortHintTagsAsc': 'Mostrar primero los usuarios sin etiquetas',
    'appUsers.sortHintTagsDesc': 'Mostrar primero los usuarios etiquetados',
    'appUsers.sortHintRoleAsc': 'Mostrar primero los miembros',
    'appUsers.sortHintRoleDesc': 'Mostrar primero superadmins, propietario y admins',
    'appUsers.sortByTitle': 'Ordenar por {column}',
    'appUsers.authMethod_email': 'Inicio de sesión con correo y contraseña',
    'appUsers.authMethod_google': 'Inicio de sesión con Google',
    'appUsers.authMethod_gmail': 'Inicio de sesión con Google',
    'appUsers.authMethod_facebook': 'Inicio de sesión con Facebook',
    'appUsers.authMethod_apple': 'Inicio de sesión con Apple',
    'appUsers.authMethod_metamask': 'Inicio de sesión con billetera (MetaMask)',
    'appUsers.authMethod_signature': 'Inicio de sesión con firma de billetera',
    'appUsers.authMethod_unknown': 'Sin método de inicio de sesión registrado',
    'appUsers.editTitle': 'Editar usuario',
    'appUsers.userUpdatedToast': 'Usuario actualizado.',
    'appUsers.userUpdateFailedPrefix': 'No se pudo actualizar el usuario:',
    'appUsers.tagFilterPrefix': 'Etiqueta:',
    'appUsers.tagFilterClear': 'Quitar el filtro de etiqueta',
    'appUsers.tagFilterTitle': 'Mostrar solo usuarios con la etiqueta {tag}',
    'appUsers.tagsModalSubtext': 'Se aplica a {count} usuario(s) seleccionado(s). Sus otras etiquetas se conservan.',
    'appUsers.tagsAddLabel': 'Añadir etiquetas',
    'appUsers.tagsAddPlaceholder': 'Escribe una etiqueta y pulsa Intro',
    'appUsers.tagsRemoveLabel': 'Quitar etiquetas',
    'appUsers.tagsRemovePlaceholder': 'Etiquetas que quitar a los usuarios seleccionados',
    'appUsers.tagsRemoveTitle': 'Haz clic para quitar esta etiqueta a los usuarios seleccionados',
    'appUsers.tagsFailedPrefix': 'No se pudieron actualizar las etiquetas:',
    'editUserModal.title': 'Editar usuario',
    'editUserModal.close': 'Cerrar',
    'editUserModal.firstName': 'Nombre',
    'editUserModal.lastName': 'Apellido',
    'editUserModal.nameRule': 'De 3 a 30 caracteres',
    'editUserModal.description': 'Descripción (opcional)',
    'editUserModal.descriptionPlaceholder': 'Una nota breve que se muestra en el perfil',
    'editUserModal.tags': 'Etiquetas',
    'editUserModal.tagsPlaceholder': 'Escribe una etiqueta y pulsa Intro',
    'editUserModal.cancel': 'Cancelar',
    'editUserModal.save': 'Guardar',
    'appUsers.colRole': 'Rol',
    'appUsers.colMfa': 'MFA',
    'appUsers.mfaOn': 'Activada',
    'appUsers.mfaOff': 'Desactivada',
    'appUsers.role_superadmin': 'Superadmin',
    'appUsers.role_owner': 'Propietario',
    'appUsers.role_admin': 'Admin',
    'appUsers.role_member': 'Miembro',
    'appUsers.tabAllUsers': 'Todos los usuarios',
    'appUsers.tabAdminAccess': 'Acceso admin',
    'appUsers.tabAdminAccessTitle': 'Solo usuarios que pueden gestionar esta aplicación en el panel de administración: propietario, admins, superadmins de la plataforma',
    'appUsers.revokeAccess': 'Quitar acceso admin',
    'appUsers.revokeAccessTitle': 'Desactivar todos los permisos del panel de administración para los usuarios seleccionados; su cuenta y el chat se mantienen',
    'appUsers.revokeAccessConfirmTitlePrefix': 'Quitar el acceso admin a',
    'appUsers.revokeAccessConfirmMessage': 'Podrán seguir iniciando sesión y chateando, pero ya no podrán gestionar esta aplicación, sus usuarios ni su configuración. Para bloquear la cuenta por completo usa Archivar. El propietario de la aplicación y tu propia cuenta se omiten.',
    'appUsers.accessRevokedToast': 'Acceso admin quitado a {count} usuario(s).',
    'appUsers.accessRevokeSelf': 'Tu propia cuenta se omitió.',
    'appUsers.accessRevokeOwner': 'El propietario de la aplicación se omitió.',
    'appUsers.accessRevokeSuperadmin': 'Un superadmin de la plataforma solo puede ser degradado por otro superadmin; se quitaron sus permisos en la aplicación.',
    'appUsers.superAdminGrant': 'Hacer superadmin',
    'appUsers.superAdminGrantTitle': 'Acceso a todas las aplicaciones y ajustes de la plataforma, como tu propia cuenta',
    'appUsers.superAdminGrantConfirmTitlePrefix': 'Hacer superadmin:',
    'appUsers.superAdminGrantConfirmMessage':
      'Un superadmin ve y gestiona todas las aplicaciones de esta instalación, puede añadir o quitar otros superadmins y no está limitado por los permisos de aplicación. Dáselo solo a quienes administran la plataforma.',
    'appUsers.superAdminGrantedToast': 'Acceso superadmin concedido a {count} usuario(s).',
    'appUsers.superAdminRevoke': 'Quitar superadmin',
    'appUsers.superAdminRevokeTitle': 'Quitar el acceso a toda la plataforma; se conservan los permisos en esta aplicación',
    'appUsers.superAdminRevokeConfirmTitlePrefix': 'Quitar superadmin a',
    'appUsers.superAdminRevokeConfirmMessage':
      'Conserva su cuenta y los permisos que tenga en esta aplicación, pero deja de ver otras aplicaciones y de administrar la plataforma.',
    'appUsers.superAdminRevokedToast': 'Acceso superadmin quitado a {count} usuario(s).',
    'appUsers.superAdminRevokeSelf': 'No puedes quitar tu propio acceso superadmin.',
    'appUsers.superAdminNotBaseApp': 'Los superadmins se gestionan desde la página Usuarios de la aplicación base.',
    'appUsers.superAdminRequired': 'Solo un superadmin puede cambiar el acceso superadmin.',
