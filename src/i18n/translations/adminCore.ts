...
export const adminCore = {
  en: {
    ...
    'agentSettings.tabWidgetAppearance': 'Widget Appearance',
  ...
  fr: {
    ...
    'agentSettings.tabWidgetAppearance': 'Apparence du widget',
  ...
  es: {
    ...
    'agentSettings.tabWidgetAppearance': 'Apariencia del widget',
