...
export const userSettings = {
  en: {
    ...
    'userSettingsPassword.forgotCurrent': 'Forgot your current password?',
    'userSettingsPassword.sendResetLink': 'Send me a reset link',
    'userSettingsPassword.resetLinkSentShort': 'Reset link sent',
    'userSettingsPassword.resetLinkSent': 'A password reset link was sent to {email}.',
    'userSettingsPassword.setHeading': 'Set a password',
    'userSettingsPassword.setDescription': 'This account signs in with Google or another provider and has no password yet. Choose one (at least 8 characters), then confirm who you are. Afterwards you can sign in either way.',
    'userSettingsPassword.setWithGoogle': 'Confirm with Google and set password',
    'userSettingsPassword.orWithCode': 'Or confirm with a code from your authenticator app or a backup code:',
    'userSettingsPassword.withCode': 'Confirm with a code from your authenticator app or a backup code:',
    'userSettingsPassword.setWithCode': 'Set password with this code',
    'userSettingsPassword.setNoMethod': 'No way to confirm your identity is available on this app yet. Ask your administrator.',
    'userSettingsPassword.toastSet': 'Password set. You can now also sign in with your email and password.',
    'userSettingsPassword.toastSetRevoked': 'Password set. {count} other session(s) signed out.',
    'userSettingsPassword.reauthFailed': 'Could not confirm your identity with the sign-in provider.',
    'userSettingsPassword.reauthMismatch': 'That provider account does not match this user.',
    'userSettingsPassword.changeWithGoogle': 'Confirm with Google instead',
    'userSettingsPassword.fillNewFirst': 'Enter and repeat the new password first',
    ...
    'userSettingsAi.newKeyLead': 'Your key is ready. Pick where you want to use it:',
    'userSettingsAi.pickClientHint': 'Each option shows the exact steps. Come back to this page any time; the status in the key list tells you when the connection works.',
    'userSettingsAi.client.claudeAi': 'Claude.ai',
    'userSettingsAi.client.claudeDesktop': 'Claude Desktop',
    'userSettingsAi.client.chatgpt': 'ChatGPT',
    'userSettingsAi.client.cursor': 'Cursor',
    'userSettingsAi.client.vscode': 'VS Code',
    'userSettingsAi.client.claudeCode': 'Claude Code',
    'userSettingsAi.client.other': 'Other',
    'userSettingsAi.steps.claudeAi': 'On claude.ai open Settings > Connectors > Add custom connector. Name it Ethora, paste the personal URL below and click Add. In a new chat, enable Ethora in the tools menu.',
    'userSettingsAi.steps.claudeDesktop': 'In Claude Desktop open Settings > Connectors > Add custom connector. Name it Ethora, paste the personal URL below and click Add.',
    'userSettingsAi.plan.claude': 'Custom connectors are available on Claude Pro, Max, Team and Enterprise. On the free plan use Cursor, VS Code or Claude Code instead.',
    'userSettingsAi.steps.chatgpt': 'In ChatGPT open Settings > Apps & Connectors > Advanced settings and turn on Developer mode. Choose Create, name it Ethora, paste the personal URL below, set Authentication to None and save. Enable it from the plus menu in a chat.',
    'userSettingsAi.plan.chatgpt': 'Custom connectors need a paid ChatGPT plan with Developer mode. On the free plan use Cursor, VS Code or Claude Code instead.',
    'userSettingsAi.steps.cursor': 'Click the install button, or add the JSON below under Cursor Settings > MCP.',
    'userSettingsAi.steps.vscode': 'Click the install button, or save the JSON below as .vscode/mcp.json in your workspace and start the server from the MCP: List Servers command.',
    'userSettingsAi.steps.claudeCode': 'Run this in a terminal inside your project. Claude Code remembers the server for that project.',
    'userSettingsAi.steps.other': 'Windsurf, Cline, Gemini CLI and most agent frameworks accept one of these. The personal URL works wherever a plain MCP URL is expected; the Bearer form is for clients that take headers.',
    'userSettingsAi.installCursor': 'Add to Cursor',
    'userSettingsAi.installVscode': 'Install in VS Code',
    'userSettingsAi.snippetJson': 'Config (JSON)',
    'userSettingsAi.snippetVscodeJson': '.vscode/mcp.json',
    'userSettingsAi.snippetBearer': 'Config with Bearer header (JSON)',
    'userSettingsAi.colStatus': 'Status',
    'userSettingsAi.statusWaiting': 'Not connected yet',
    'userSettingsAi.statusIdle': 'No requests yet',
    'userSettingsAi.statusWaitingHint': 'Waiting for the first request from your assistant',
    'userSettingsAi.statusConnected': 'Connected',
    'userSettingsAi.statusVia': 'via {client}',
    'userSettingsAi.justNow': 'just now',
    'userSettingsAi.ago': '{time} ago',
    'userSettingsAi.refreshStatus': 'Refresh status',
    'userSettingsAi.regenerateButton': 'Regenerate',
    'userSettingsAi.regenerateTitle': 'Regenerate this key?',
    'userSettingsAi.regenerateMessage': 'A new key with the same name and validity replaces this one. The old key stops working immediately and the new connection details are shown once.',
    'userSettingsAi.regenerateConfirm': 'Regenerate',
    'userSettingsAi.toastRegenerated': 'Key regenerated. Copy the new details below.',
  ...
  fr: {
    ...
    'userSettingsPassword.forgotCurrent': 'Mot de passe actuel oublié ?',
    'userSettingsPassword.sendResetLink': 'Envoyer un lien de réinitialisation',
    'userSettingsPassword.resetLinkSentShort': 'Lien envoyé',
    'userSettingsPassword.resetLinkSent': 'Un lien de réinitialisation a été envoyé à {email}.',
    'userSettingsPassword.setHeading': 'Définir un mot de passe',
    'userSettingsPassword.setDescription': 'Ce compte se connecte avec Google ou un autre fournisseur et n\'a pas encore de mot de passe. Choisissez-en un (8 caractères minimum), puis confirmez votre identité. Vous pourrez ensuite vous connecter des deux façons.',
    'userSettingsPassword.setWithGoogle': 'Confirmer avec Google et définir le mot de passe',
    'userSettingsPassword.orWithCode': 'Ou confirmez avec un code de votre application d\'authentification ou un code de secours :',
    'userSettingsPassword.withCode': 'Confirmez avec un code de votre application d\'authentification ou un code de secours :',
    'userSettingsPassword.setWithCode': 'Définir le mot de passe avec ce code',
    'userSettingsPassword.setNoMethod': 'Aucun moyen de confirmer votre identité n\'est disponible sur cette application pour le moment. Contactez votre administrateur.',
    'userSettingsPassword.toastSet': 'Mot de passe défini. Vous pouvez désormais aussi vous connecter avec votre e-mail et votre mot de passe.',
    'userSettingsPassword.toastSetRevoked': 'Mot de passe défini. {count} autre(s) session(s) déconnectée(s).',
    'userSettingsPassword.reauthFailed': 'Impossible de confirmer votre identité auprès du fournisseur de connexion.',
    'userSettingsPassword.reauthMismatch': 'Ce compte fournisseur ne correspond pas à cet utilisateur.',
    'userSettingsPassword.changeWithGoogle': 'Confirmer avec Google à la place',
    'userSettingsPassword.fillNewFirst': 'Saisissez et répétez d\'abord le nouveau mot de passe',
    ...
    'userSettingsAi.newKeyLead': 'Votre clé est prête. Choisissez où l\'utiliser :',
    'userSettingsAi.pickClientHint': 'Chaque option affiche les étapes exactes. Revenez sur cette page quand vous voulez ; le statut dans la liste des clés indique quand la connexion fonctionne.',
    'userSettingsAi.client.claudeAi': 'Claude.ai',
    'userSettingsAi.client.claudeDesktop': 'Claude Desktop',
    'userSettingsAi.client.chatgpt': 'ChatGPT',
    'userSettingsAi.client.cursor': 'Cursor',
    'userSettingsAi.client.vscode': 'VS Code',
    'userSettingsAi.client.claudeCode': 'Claude Code',
    'userSettingsAi.client.other': 'Autre',
    'userSettingsAi.steps.claudeAi': 'Sur claude.ai, ouvrez Paramètres > Connecteurs > Ajouter un connecteur personnalisé. Nommez-le Ethora, collez l\'URL personnelle ci-dessous et cliquez sur Ajouter. Dans une nouvelle discussion, activez Ethora dans le menu des outils.',
    'userSettingsAi.steps.claudeDesktop': 'Dans Claude Desktop, ouvrez Paramètres > Connecteurs > Ajouter un connecteur personnalisé. Nommez-le Ethora, collez l\'URL personnelle ci-dessous et cliquez sur Ajouter.',
    'userSettingsAi.plan.claude': 'Les connecteurs personnalisés sont disponibles avec Claude Pro, Max, Team et Enterprise. Avec l\'offre gratuite, utilisez plutôt Cursor, VS Code ou Claude Code.',
    'userSettingsAi.steps.chatgpt': 'Dans ChatGPT, ouvrez Paramètres > Apps et connecteurs > Paramètres avancés et activez le mode Développeur. Choisissez Créer, nommez-le Ethora, collez l\'URL personnelle ci-dessous, réglez l\'authentification sur Aucune et enregistrez. Activez-le depuis le menu plus dans une discussion.',
    'userSettingsAi.plan.chatgpt': 'Les connecteurs personnalisés nécessitent une offre ChatGPT payante avec le mode Développeur. Avec l\'offre gratuite, utilisez plutôt Cursor, VS Code ou Claude Code.',
    'userSettingsAi.steps.cursor': 'Cliquez sur le bouton d\'installation, ou ajoutez le JSON ci-dessous dans Cursor : Paramètres > MCP.',
    'userSettingsAi.steps.vscode': 'Cliquez sur le bouton d\'installation, ou enregistrez le JSON ci-dessous dans .vscode/mcp.json de votre espace de travail, puis démarrez le serveur via la commande MCP: List Servers.',
    'userSettingsAi.steps.claudeCode': 'Exécutez ceci dans un terminal à l\'intérieur de votre projet. Claude Code mémorise le serveur pour ce projet.',
    'userSettingsAi.steps.other': 'Windsurf, Cline, Gemini CLI et la plupart des frameworks d\'agents acceptent l\'un de ces formats. L\'URL personnelle fonctionne partout où une simple URL MCP est attendue ; la forme Bearer est pour les clients qui acceptent des en-têtes.',
    'userSettingsAi.installCursor': 'Ajouter à Cursor',
    'userSettingsAi.installVscode': 'Installer dans VS Code',
    'userSettingsAi.snippetJson': 'Configuration (JSON)',
    'userSettingsAi.snippetVscodeJson': '.vscode/mcp.json',
    'userSettingsAi.snippetBearer': 'Configuration avec en-tête Bearer (JSON)',
    'userSettingsAi.colStatus': 'Statut',
    'userSettingsAi.statusWaiting': 'Pas encore connectée',
    'userSettingsAi.statusIdle': 'Aucune requête pour l\'instant',
    'userSettingsAi.statusWaitingHint': 'En attente de la première requête de votre assistant',
    'userSettingsAi.statusConnected': 'Connectée',
    'userSettingsAi.statusVia': 'via {client}',
    'userSettingsAi.justNow': 'à l\'instant',
    'userSettingsAi.ago': 'il y a {time}',
    'userSettingsAi.refreshStatus': 'Actualiser le statut',
    'userSettingsAi.regenerateButton': 'Régénérer',
    'userSettingsAi.regenerateTitle': 'Régénérer cette clé ?',
    'userSettingsAi.regenerateMessage': 'Une nouvelle clé avec le même nom et la même validité remplace celle-ci. L\'ancienne clé cesse de fonctionner immédiatement et les nouvelles informations de connexion ne sont affichées qu\'une fois.',
    'userSettingsAi.regenerateConfirm': 'Régénérer',
    'userSettingsAi.toastRegenerated': 'Clé régénérée. Copiez les nouvelles informations ci-dessous.',
  ...
  es: {
    ...
    'userSettingsPassword.forgotCurrent': '¿Olvidaste tu contraseña actual?',
    'userSettingsPassword.sendResetLink': 'Enviarme un enlace de restablecimiento',
    'userSettingsPassword.resetLinkSentShort': 'Enlace enviado',
    'userSettingsPassword.resetLinkSent': 'Se envió un enlace de restablecimiento a {email}.',
    'userSettingsPassword.setHeading': 'Crear una contraseña',
    'userSettingsPassword.setDescription': 'Esta cuenta inicia sesión con Google u otro proveedor y aún no tiene contraseña. Elige una (mínimo 8 caracteres) y confirma tu identidad. Después podrás iniciar sesión de ambas formas.',
    'userSettingsPassword.setWithGoogle': 'Confirmar con Google y crear la contraseña',
    'userSettingsPassword.orWithCode': 'O confirma con un código de tu aplicación de autenticación o un código de respaldo:',
    'userSettingsPassword.withCode': 'Confirma con un código de tu aplicación de autenticación o un código de respaldo:',
    'userSettingsPassword.setWithCode': 'Crear la contraseña con este código',
    'userSettingsPassword.setNoMethod': 'Todavía no hay forma de confirmar tu identidad en esta aplicación. Consulta a tu administrador.',
    'userSettingsPassword.toastSet': 'Contraseña creada. Ahora también puedes iniciar sesión con tu correo y contraseña.',
    'userSettingsPassword.toastSetRevoked': 'Contraseña creada. Se cerraron {count} sesión(es) en otros dispositivos.',
    'userSettingsPassword.reauthFailed': 'No se pudo confirmar tu identidad con el proveedor de inicio de sesión.',
    'userSettingsPassword.reauthMismatch': 'Esa cuenta del proveedor no coincide con este usuario.',
    'userSettingsPassword.changeWithGoogle': 'Confirmar con Google en su lugar',
    'userSettingsPassword.fillNewFirst': 'Introduce y repite primero la nueva contraseña',
    ...
    'userSettingsAi.newKeyLead': 'Tu clave está lista. Elige dónde quieres usarla:',
    'userSettingsAi.pickClientHint': 'Cada opción muestra los pasos exactos. Vuelve a esta página cuando quieras; el estado en la lista de claves te indica cuándo funciona la conexión.',
    'userSettingsAi.client.claudeAi': 'Claude.ai',
    'userSettingsAi.client.claudeDesktop': 'Claude Desktop',
    'userSettingsAi.client.chatgpt': 'ChatGPT',
    'userSettingsAi.client.cursor': 'Cursor',
    'userSettingsAi.client.vscode': 'VS Code',
    'userSettingsAi.client.claudeCode': 'Claude Code',
    'userSettingsAi.client.other': 'Otro',
    'userSettingsAi.steps.claudeAi': 'En claude.ai abre Configuración > Conectores > Añadir conector personalizado. Llámalo Ethora, pega la URL personal de abajo y pulsa Añadir. En un chat nuevo, activa Ethora en el menú de herramientas.',
    'userSettingsAi.steps.claudeDesktop': 'En Claude Desktop abre Configuración > Conectores > Añadir conector personalizado. Llámalo Ethora, pega la URL personal de abajo y pulsa Añadir.',
    'userSettingsAi.plan.claude': 'Los conectores personalizados están disponibles en Claude Pro, Max, Team y Enterprise. En el plan gratuito usa Cursor, VS Code o Claude Code.',
    'userSettingsAi.steps.chatgpt': 'En ChatGPT abre Configuración > Apps y conectores > Configuración avanzada y activa el modo Desarrollador. Elige Crear, llámalo Ethora, pega la URL personal de abajo, pon Autenticación en Ninguna y guarda. Actívalo desde el menú más en un chat.',
    'userSettingsAi.plan.chatgpt': 'Los conectores personalizados requieren un plan de pago de ChatGPT con el modo Desarrollador. En el plan gratuito usa Cursor, VS Code o Claude Code.',
    'userSettingsAi.steps.cursor': 'Pulsa el botón de instalación o añade el JSON de abajo en Cursor: Configuración > MCP.',
    'userSettingsAi.steps.vscode': 'Pulsa el botón de instalación o guarda el JSON de abajo como .vscode/mcp.json en tu espacio de trabajo y arranca el servidor con el comando MCP: List Servers.',
    'userSettingsAi.steps.claudeCode': 'Ejecuta esto en una terminal dentro de tu proyecto. Claude Code recuerda el servidor para ese proyecto.',
    'userSettingsAi.steps.other': 'Windsurf, Cline, Gemini CLI y la mayoría de frameworks de agentes aceptan uno de estos formatos. La URL personal funciona donde se espere una URL MCP simple; la forma Bearer es para clientes que aceptan cabeceras.',
    'userSettingsAi.installCursor': 'Añadir a Cursor',
    'userSettingsAi.installVscode': 'Instalar en VS Code',
    'userSettingsAi.snippetJson': 'Configuración (JSON)',
    'userSettingsAi.snippetVscodeJson': '.vscode/mcp.json',
    'userSettingsAi.snippetBearer': 'Configuración con cabecera Bearer (JSON)',
    'userSettingsAi.colStatus': 'Estado',
    'userSettingsAi.statusWaiting': 'Aún no conectada',
    'userSettingsAi.statusIdle': 'Sin peticiones todavía',
    'userSettingsAi.statusWaitingHint': 'Esperando la primera petición de tu asistente',
    'userSettingsAi.statusConnected': 'Conectada',
    'userSettingsAi.statusVia': 'vía {client}',
    'userSettingsAi.justNow': 'ahora mismo',
    'userSettingsAi.ago': 'hace {time}',
    'userSettingsAi.refreshStatus': 'Actualizar estado',
    'userSettingsAi.regenerateButton': 'Regenerar',
    'userSettingsAi.regenerateTitle': '¿Regenerar esta clave?',
    'userSettingsAi.regenerateMessage': 'Una clave nueva con el mismo nombre y validez sustituye a esta. La clave antigua deja de funcionar de inmediato y los nuevos datos de conexión se muestran una sola vez.',
    'userSettingsAi.regenerateConfirm': 'Regenerar',
    'userSettingsAi.toastRegenerated': 'Clave regenerada. Copia los nuevos datos abajo.',
