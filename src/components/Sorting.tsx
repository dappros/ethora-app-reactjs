import { CloseButton, Field, Label, Popover, PopoverButton, PopoverPanel, Radio, RadioGroup } from "@headlessui/react"
...
export function Sorting({ orderByList, order, setOrder, orderBy, setOrderBy, className }: Props) {
