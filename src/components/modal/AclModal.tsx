                                        ...
                                        <td>
                                            <Field className="checkbox  mb-6">
                                                <Checkbox
                                                    ...
                                                    onChange={(isSet) => onChange(isSet, "application.appCreate.create")}
                                                    disabled
                                                >
                                                </Checkbox>
                                            </Field>
                                        ...
                                        <td>
                                            <Field className="checkbox  mb-6">
                                                <Checkbox
                                                    ...
                                                    onChange={(isSet) => onChange(isSet, "application.appSettings.read")}
                                                >
                                                </Checkbox>
                                            </Field>
                                        </td>
                                        ...
                                        <td>
                                            <Field className="checkbox  mb-6">
                                                <Checkbox
                                                    ...
                                                    onChange={(isSet) => onChange(isSet, "application.appSettings.admin")}
                                                >
                                                </Checkbox>
                                            </Field>
                                        </td>
                                        ...
                                        <td>
                                            <Field className="checkbox  mb-6">
                                                <Checkbox
                                                    ...
                                                    onChange={(isSet) => onChange(isSet, "application.appUsers.create")}
                                                >
                                                </Checkbox>
                                            </Field>
                                        </td>
                                        <td>
                                            <Field className="checkbox  mb-6">
                                                <Checkbox
                                                    ...
                                                    onChange={(isSet) => onChange(isSet, "application.appUsers.read")}
                                                >
                                                </Checkbox>
                                            </Field>
                                        </td>
                                        <td>
                                            <Field className="checkbox  mb-6">
                                                <Checkbox
                                                    ...
                                                    onChange={(isSet) => onChange(isSet, "application.appUsers.update")}
                                                >
                                                </Checkbox>
                                            </Field>
                                        </td>
                                        <td>
                                            <Field className="checkbox  mb-6">
                                                <Checkbox
                                                    ...
                                                    onChange={(isSet) => onChange(isSet, "application.appUsers.delete")}
                                                >
                                                </Checkbox>
                                            </Field>
                                        </td>
                                        <td>
                                            <Field className="checkbox  mb-6">
                                                <Checkbox
                                                    ...
                                                    onChange={(isSet) => onChange(isSet, "application.appUsers.admin")}
                                                >
                                                </Checkbox>
                                            </Field>
                                        </td>
                                        ...
                                        <td>
                                            <Field className="checkbox  mb-6">
                                                <Checkbox
                                                    ...
                                                    onChange={(isSet) => onChange(isSet, "application.appTokens.create")}
                                                >
                                                </Checkbox>
                                            </Field>
                                        </td>
                                        <td>
                                            <Field className="checkbox  mb-6">
                                                <Checkbox
                                                    ...
                                                    onChange={(isSet) => onChange(isSet, "application.appTokens.read")}
                                                >
                                                </Checkbox>
                                            </Field>
                                        </td>
                                        <td>
                                            <Field className="checkbox  mb-6">
                                                <Checkbox
                                                    ...
                                                    onChange={(isSet) => onChange(isSet, "application.appTokens.update")}
                                                >
                                                </Checkbox>
                                            </Field>
                                        </td>
                                        ...
                                        <td>
                                            <Field className="checkbox  mb-6">
                                                <Checkbox
                                                    ...
                                                    onChange={(isSet) => onChange(isSet, "application.appTokens.admin")}
                                                >
                                                </Checkbox>
                                            </Field>
                                        </td>
