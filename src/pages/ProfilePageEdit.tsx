...
export function ProfilePageEdit() {
    ...
    const [profileImage, setProfileImage] = useState(profileImage_ ? profileImage_ : '')
    ...
    const onSubmit: SubmitHandler<Inputs> = ({ firstName, lastName, description }) => {
        let fd = new FormData()
            ...
            <div className="app-content-body">
                <div className="profile-page-edit">
                    <div className="profile-top">
                        <button className="gen-tertiary-btn" onClick={() => navigate("/app/profile")}>Cancel</button>
                        <div>
                            <button className="gen-secondary-btn medium" onClick={onSave}>Save</button>
                        </div>
                    </div>
                    <ProfilePageUserIcon firstName={fName} lastName={lName as string} profileImage={profileImage} setProfileImage={setProfileImage} editMode />
                    <div className="form">
