    ...
    if (length > 0) {
      return (
        <div className="selected-actions">
          <div className="selected-actions-title mr-16">
            Selected {length} of {itemsPerTable} users
          </div>
          <button
            className="gen-tertiary-btn middle mr-16"
          ...
          <button
            className="gen-tertiary-btn middle danger mr-16"
    ...
    <div className="app-content-body-page admin-app-users">
              ...
              <div className="items-in-table-options">
                <MenuItem>
                  <div
                    ...
                    className="items-in-table-option"
                  >
                    {10}
                  </div>
                </MenuItem>
      ...
      {showManageTags && (
        <SubmitModal onClose={() => setShowManageTags(false)}>
          ...
          <div className="text-center">Add Tags</div>
          <div>
            <TextInput
              value={tags}
